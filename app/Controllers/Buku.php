...
class Buku extends BaseController
{
    ...
    public function list()
    {
        ...
        $list = $this->BukuModel->select('buku.id, buku.judul,stok, kategori.nama AS kategori_nama')->join('kategori','buku.kategori_id = kategori.id')->orderBy('kategori.nama, judul')->findAll();
