...
class PeminjamanBuku extends BaseController
{
    ...
    public function delete($peminjaman, $peminjaman_buku, $buku_id)
  {
    $peminjaman = $this->PeminjamanBukuModel->where('id', $peminjaman_buku)->first();
    ...
    // delete 
    $this->PeminjamanBukuModel->where('id', $peminjaman_buku)->delete();
