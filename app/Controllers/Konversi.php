...
class Konversi extends BaseController
{
    ...
    public function list()
    {
        ...
        $list = $this->KonversiModel->select('konversi.satuan_id, konversi.id, satuan.nama, konversi.suhu, konversi.kondisi')->join('satuan','konversi.satuan_id = satuan.id')->orderBy('satuan.nama, nama')->findAll();
